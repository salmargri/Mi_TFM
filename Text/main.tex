...
Firstly, we need to give a mathematical description of our noise $\mathcal{E}$ \cite{Girvin2023}. Physically, noise represents an interaction between the system and the enviroment. Since we do not have access to the enviroment, the action of noise on the system appears to be a non-unitary operation, and we cannot describe our qubit as if it was in a pure state. This forces us to use the density matrix 
